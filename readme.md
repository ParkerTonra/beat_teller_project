Beat Teller is a web application that uses a trained neural network to predict the tempo of an audio file. The application is built using Flask and PyTorch.
